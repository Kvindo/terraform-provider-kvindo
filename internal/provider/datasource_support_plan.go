...
func NewSupportPlanDataSource() datasource.DataSource { return &SupportPlanDataSource{} }
...
func (d *SupportPlanDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if idSet {
		...
		apiData, err = d.client.GetByName(ctx, "/api/v1/support-plan", state.Name.ValueString())
	}
	if err != nil {
