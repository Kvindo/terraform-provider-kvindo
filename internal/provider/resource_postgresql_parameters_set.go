...
// PostgresqlParametersSetResourceModel describes the resource data model.
...
// PostgresqlParametersSetResource defines the resource implementation.
type PostgresqlParametersSetResource struct {
...
func buildPostgresqlParametersSetRequestMap(ctx context.Context, plan PostgresqlParametersSetResourceModel) map[string]interface{} {
	...
	if !plan.Parameters.IsNull() && !plan.Parameters.IsUnknown() {
		m["parameters"] = stringMapToInterface(ctx, plan.Parameters)
	}
	return m
}
...
func populatePostgresqlParametersSetState(ctx context.Context, data map[string]interface{}, state *PostgresqlParametersSetResourceModel) error {
	...
	state.Parameters = getStringMap(data, "parameters")
